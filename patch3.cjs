...
// Since there might be slight whitespace differences, we will use a regex to match from `} else {` to the end of the action prompt.
const regex = /\} else \{\s+actionPrompt = \`أريد تأليف كتاب متكامل بعنوان[\s\S]*?صفحات منفصلة\.\`;\s+\}/;
