...
// Find the start and end of handleGenerateBook
const startMarker = "const handleGenerateBook = () => {";
const endMarker = "  const handleGenerateCover = async () => {";

let startIndex = code.indexOf(startMarker);
let endIndex = code.indexOf(endMarker);

if (startIndex !== -1 && endIndex !== -1) {
    const newFunction = `const handleGenerateBook = () => {
